...
- *Internet Explorer* mode does not support modern *CSS* features, especially like `grid`
  ...
  <details>
    <summary>Codes : VbsCalculator.html</summary>
  ...
  <details>
    <summary>Codes : VbsCalculator.css</summary>
  ...
  <details>
    <summary>Codes : VbsCalculator.vbs</summary>
...
- It requires enabling script execution in *Internet Explorer* mode
  ...
  <details>
    <summary>Codes : VbsHelloWorld.html</summary>
  ...
  <details>
    <summary>Codes : VbsHelloWorld.vbs</summary>
